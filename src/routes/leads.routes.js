...
const atualizarLeadSchema = z.object({
  ...
  dataPreenchimento: z.string().optional().nullable(),
  data_preenchimento: z.string().optional().nullable(),
  ...
  etapaFunil: z.string().optional().nullable(),
  etapa_funil: z.string().optional().nullable(),
  ...
  dadosRespondi: z.record(z.any()).optional().nullable(),
  dados_respondi: z.record(z.any()).optional().nullable(),
...
router.get('/metricas-anuncio', autenticar, leadsController.metricasAnuncio);
